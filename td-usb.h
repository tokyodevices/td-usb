...
#define OPTION_OPERATION_LIST			0
#define OPTION_OPERATION_LISTEN			1
#define OPTION_OPERATION_READ			2
#define OPTION_OPERATION_WRITE			3
#define OPTION_OPERATION_INIT			12
#define OPTION_OPERATION_DFU			13
#define OPTION_OPERATION_ERASE			14
